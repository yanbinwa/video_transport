...
from core.utils.video.video_spilt_with_llm import get_time_ranges
...
class VideoSpiltTest(unittest.TestCase):
    ...
    def test_get_time_ranges(self):
        print(get_time_ranges(llm_response))
